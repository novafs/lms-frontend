...
export const createCourse = async (data) => apiInstanceAuth.post('/courses', data).then((res) => res.data)
...
export const updateCourse = async (data, id) => apiInstanceAuth.put(`/courses/${id}`, data).then((res) => res.data)
